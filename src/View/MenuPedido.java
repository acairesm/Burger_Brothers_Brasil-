...
public class MenuPedido {
    ...
    public static void exibir() {
        ...
        do {
            ...
            System.out.println(ANSI_RED + "❌ [3] Excluir Pedido" + ANSI_RESET); // (Changed color to RED for consistency)
            System.out.println(ANSI_GREEN + "✏️ [4] Alterar Pedido" + ANSI_RESET); //
    ...
    private static void excluirPedido() {
        ...
        for (int i = 0; i < pedidos.size(); i++) {
            // Assuming Pedido has getCliente(), getNome(), getData() for a summary
             System.out.println("[" + (i + 1) + "] Pedido de " + pedidos.get(i).getCliente().getNome() + //
                               " em " + pedidos.get(i).getData() + // Needs Pedido.getData()
        ...
        PedidoController.removerPedido(indicePedido); // Uses the modified removerPedido in PedidoController
    }
    ...
    private static void alterarPedido() {
        ...
        System.out.println(ANSI_YELLOW + "Pedidos existentes:" + ANSI_RESET);
         for (int i = 0; i < pedidos.size(); i++) {
            System.out.println("[" + (i + 1) + "] " + pedidos.get(i)); // Uses Pedido.toString()
        }
        ...
        do {
            ...
            System.out.println(pedidoParaAlterar.toString()); // Display current state of order
            ...
            switch (opcaoAlteracao) {
                ...
                case 2: // Remover Item
                    List<ItemPedido> itensNoPedido = pedidoParaAlterar.getItens(); // Needs Pedido.getItens()
         ...
         System.out.println(ANSI_GREEN + "Pedido atualizado com sucesso!" + ANSI_RESET); // The object in the list is updated by reference
    }
    ...
    private static void listarPedidos() {
        ...
        for (int i = 0; i < pedidos.size(); i++) {
            ...
            System.out.println(pedidos.get(i)); // Relies on a good Pedido.toString() method
            System.out.println(ANSI_BLUE + "---------------------------------" + ANSI_RESET);
        }
    }
}